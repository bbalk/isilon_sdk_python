...
class LicenseApi(object):
    ...
    def get_license_generate_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if 'licenses_to_include' in params and not re.search(r'.+', params['licenses_to_include']):  # noqa: E501
        ...
        if 'licenses_to_exclude' in params and not re.search(r'.+', params['licenses_to_exclude']):  # noqa: E501
        ...
        if 'only_these_licenses' in params and not re.search(r'.+', params['only_these_licenses']):  # noqa: E501
